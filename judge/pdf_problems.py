...
page.paperSize = {
    ...
    footer: {
        ...
        contents: phantom.callback(function(num, pages) {
            return ('<center style="margin: 0 auto; font-family: "Merriweather Sans"; font-size: 10px">'
...
try {
    ...
    branch.setCharPref('x-western', 'Merriweather Sans');
...
puppeteer.launch().then(browser => Promise.resolve()
    .then(async () => {
        ...
        await page.pdf({
            ...
            footerTemplate: '<center style="margin: 0 auto; font-family: "Merriweather Sans"; font-size: 10px">' +
