...
page.paperSize = {
    ...
    footer: {
        ...
        contents: phantom.callback(function(num, pages) {
            return ('<center style="margin: 0 auto; font-family: Roboto; font-size: 10px">'
...
try {
    ...
    branch.setCharPref('x-western', 'Roboto');
...
puppeteer.launch().then(browser => Promise.resolve()
    .then(async () => {
        ...
        await page.pdf({
            ...
            footerTemplate: '<center style="margin: 0 auto; font-family: Roboto; font-size: 10px">' +
